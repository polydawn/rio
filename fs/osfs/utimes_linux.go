...
func (afs *osFS) SetTimesLNano(path fs.RelPath, mtime time.Time, atime time.Time) fs.ErrFS {
...
func (afs *osFS) SetTimesNano(path fs.RelPath, mtime time.Time, atime time.Time) fs.ErrFS {
